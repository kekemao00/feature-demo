...
public class Aes {
    ...
    public static CipherInputStream fileDecryByStream(InputStream inputStream,byte[] key)
    {
    ...
    public static String decryptBase64(String content, String key) {
        ...
        byte[] data = Base64.decode(content.getBytes(),Base64.DEFAULT);
       // byte[] data = Hex.parse(hexStr);
        /*try {
            data = hex2byte(content);
        } catch (Exception e) {
            e.printStackTrace();
